...
cmd_run_nipy_coreg <- function(
  ...
  template <- readLines(system.file("shell-templates/rave-nipy-coregistration.R", package = "ravecore"))
  ...
  script_path <- normalizePath(
    file.path(subject$imaging_path, "scripts", "cmd-rave-nipy-coregistration.R"),
    mustWork = FALSE, winslash = "/"
  )
