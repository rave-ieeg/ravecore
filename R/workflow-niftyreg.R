...
niftyreg_coreg <- function(
  ...
  # ravetools will ensure these two packages
...
cmd_run_niftyreg_coreg <- function(
  ...
  template <- readLines(system.file("shell-templates/rave-nifty-coregistration.R", package = "ravecore"))
  ...
  script_path <- normalizePath(
    file.path(subject$imaging_path, "scripts", "cmd-nifty-coregistration.R"),
    mustWork = FALSE, winslash = "/"
  )
