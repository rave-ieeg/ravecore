#' @title Legacy support for 'RAVE' 1.0 format
...
#' @returns Nothing
#' @export
rave_legacy_subject_format_conversion <- function(
  ...
  block_lengths <- ravepipeline::lapply_jobs(seq_along(electrodes), function(ii) {
    e <- electrodes[[ii]]
  ...
  block_lengths <- drop_nulls(block_lengths)
