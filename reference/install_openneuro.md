...
Enjoy hundreds of open-access data sets from <https://openneuro.org>
with a simple accession number.
...
- subject_codes:
  ...
  subject codes, with or without the prefix `'sub-'`, default is `NULL`
  to download the entire data repository

- tag:

  version number; default is `NULL` to download the latest version

- parent_folder:

  parent directory where the data will be downloaded into the data
  folder name is always the accession number
